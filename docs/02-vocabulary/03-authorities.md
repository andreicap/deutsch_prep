# Vocabulary Pack 03 — Behörden / Ämter (Authorities)
...
| vorlegen | to present/submit | Bitte legen Sie Ihren Pass vor. |
| abholen | to pick up | Ich muss den Ausweis abholen. |
...
| Wann sind die Öffnungszeiten? | When are the opening hours? |
| Ich habe eine Frage zu meiner Aufenthaltsbewilligung. | I have a question about my residence permit. |
| Mein Ausweis läuft am… ab. | My permit expires on… |
| Kann ich das online machen? | Can I do this online? |
| Ich habe das Formular ausgefüllt. | I've filled in the form. |
