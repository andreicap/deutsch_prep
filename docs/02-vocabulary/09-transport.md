# Vocabulary Pack 09 — Verkehr / Mobilität (Transport)
...
| aussteigen | to get off | Ich steige am Hauptbahnhof aus. |
| ankommen | to arrive | Der Zug kommt um 8 Uhr an. |
| abfahren | to depart | Der Bus fährt um 7:30 ab. |
| verpassen | to miss | Ich habe den Zug verpasst. |
| buchen | to book | Ich buche ein Billett online. |
| parken | to park | Wo kann ich parken? |
...
| Einmal nach Zürich, bitte. | One ticket to Zurich, please. |
...
| Ich habe ein Halbtax. | I have a half-fare card. |
...
| **ZVV** | Zürich transport network |
| **Libero** | Bern transport network |
