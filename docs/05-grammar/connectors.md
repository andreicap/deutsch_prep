...
| denn | because | Ich lerne Deutsch, denn ich lebe in der Schweiz. |
| sondern | but rather | Er arbeitet nicht, sondern er studiert. |
...
Subordinate clause: ...weil ich in Zürich lebe. (verb at the end)
```
...
| darum / daher | for that reason | Ich bin müde. **Darum** gehe ich früh ins Bett. |
| dann | then | Zuerst esse ich. **Dann** gehe ich zur Arbeit. |
...
2. zwar… aber: ___
3. nicht nur… sondern auch: ___
4. sowohl… als auch: ___
5. je… desto: ___
...
| therefore | deshalb | inversion (V2) |
| nevertheless | trotzdem | inversion (V2) |
| moreover | ausserdem | inversion (V2) |
| on one hand / other | einerseits / andererseits | inversion (V2) |
| in my opinion | meiner Meinung nach | inversion (V2) |
