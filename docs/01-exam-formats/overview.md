...
| Skill | Format | Duration (approx.) | Levels |
|-------|--------|-------------------|--------|
| **Reading** | On-screen tasks (drag & drop, MC, true/false) | ~30 min | pre-A1 → B2 |
| **Listening** | Audio with on-screen tasks | ~30 min | pre-A1 → B2 |
