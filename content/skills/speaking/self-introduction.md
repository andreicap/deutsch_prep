---
title: "Sprechmodul: Selbstvorstellung (Self-Introduction)"
weight: 20
---

> Dauer (Duration): 60–90 Sekunden. Das ist sehr wahrscheinlich Ihre erste Sprechaufgabe.
...
```
1. Name + origin
2. Where you live (in Switzerland)
3. Family situation
4. Job / occupation
5. How long in Switzerland
6. Languages
7. Hobbies / free time
8. Why you're learning German
```

You don't need all 8 points — pick 5–6 that feel natural.
...
- [ ] Write your own introduction (using the template)
- [ ] Read it aloud 3 times
- [ ] Record yourself (without reading) — aim for 60–90 seconds
- [ ] Listen back: Is it natural? Clear? Complete?
- [ ] Practice with a partner: have them ask follow-up questions
- [ ] Repeat until you can do it comfortably without notes
