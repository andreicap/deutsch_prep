...
| eröffnen | to open (account) | Ich möchte ein Konto eröffnen. |
| kündigen | to cancel/terminate | Ich kündige die Versicherung. |
| wechseln | to change/switch | Ich möchte die Krankenkasse wechseln. |
| versichern | to insure | Sind Sie versichert? |
| schicken / senden | to send | Ich schicke ein Paket. |
| empfangen | to receive | Ich habe ein Paket empfangen. |
...
| Können Sie mir den Kontoauszug zeigen? | Can you show me the bank statement? |
| Ich möchte Geld überweisen. | I'd like to transfer money. |
| Was ist meine IBAN? | What is my IBAN? |
| Ich möchte meine Krankenkasse wechseln. | I'd like to switch my health insurance. |
| Wie hoch ist die monatliche Prämie? | How much is the monthly premium? |
| Welche Franchise empfehlen Sie? | Which deductible do you recommend? |
| Ich muss einen Schadenfall melden. | I need to report a claim. |
...
- You can choose your **Franchise** (300–2500 CHF): higher franchise = lower monthly premium
- **Prämienverbilligung**: premium reduction for low income — apply at your canton
...
- [ ] I understand Swiss health insurance terms (Franchise, Prämie, Grundversicherung)
- [ ] I can write an email to my insurance company
