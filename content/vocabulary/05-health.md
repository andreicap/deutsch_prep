...
| verschreiben | to prescribe | Der Arzt hat mir Tabletten verschrieben. |
| untersuchen | to examine | Der Arzt untersucht mich. |
| krank sein | to be sick | Ich bin seit gestern krank. |
| sich erholen | to recover | Ich muss mich erholen. |
| einnehmen | to take (medicine) | Nehmen Sie das dreimal täglich ein. |
| sich anmelden | to register/check in | Bitte melden Sie sich an der Rezeption an. |
...
| Seit wann haben Sie die Beschwerden? | Since when have you had these symptoms? |
| Seit gestern / seit einer Woche. | Since yesterday / for a week. |
...
| Rufen Sie den Krankenwagen! | Call the ambulance! |
...
3. **Warten** — wait in the waiting room (Wartezimmer)
4. **Untersuchung** — describe symptoms, doctor examines you
5. **Diagnose** — doctor explains what's wrong
6. **Rezept bekommen** — get a prescription if needed
...
- [ ] I know the steps of a doctor visit (for speaking task)
- [ ] I can name 10 healthy foods in German
